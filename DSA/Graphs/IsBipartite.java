...
public class IsBipartite {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // if it is possible to divide vertices into 2 mutually exclusive and exhaustive sets such that all edges are across sets
    // every non-cyclic graph is bi-partite and if cycle exists it should be even vertices
